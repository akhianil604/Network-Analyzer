...
def monitor_network(duration=60):
    """
    Monitor network performance for a specified duration and report statistics
    on UDP packet loss and TCP connections.
...
def start_monitoring_interface():
    """
    Interactive function to start network performance monitoring with user input.
    """
    try:
